...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Wooshie Wash : A Complete Wash</title>
        ...
        <div class="container">
          <header class="section-header">
            <div class="text-dark wow fadeInUp lead">
              <h3 class="text-dark">Wooshie Wash : A Complete Wash</h3>
              <p><b>
                This isn't some kind of normal wash... This is the ULTIMATE Wash
                that a vehicle can have. Of course it will take few minutes. And
                after that your vehicle's appearance will be a brand new type.
              </p>
              <p>
              ...
              <form action="bookingDetails.jsp" method="POST">
                <div class="form-group">
                  ...
                  <input type="hidden" value="Wash" name="serviceType">
                  <input
                    type="text"
